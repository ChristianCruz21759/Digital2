...
void __interrupt() isr(void) {
    ...
    if(SSPIF == 1){     // Interrupcion comunicacion SPI
        
        // Condicion para enviar el contador o el potenciometro
        (spiRead() == 0)? spiWrite(valCount): spiWrite(valPot1);
